...
date::date( const time_t tSysTime )
{
	struct tm *ptm;
	int y, m, d;
...
int date::DayOfMonth (int year,int month)
{
...
int date::IsLeapYear( const int iYear )
{
	long jd1, jd2;
...
int date::DayOfWorkWeek( void ) const
{
...
void date::YMD( int *pY, int *pM, int *pD )
{
